---
title: Programming Kendryte K210
date: 2026-11-18
draft: false
image: img/2020/gd32v-rotozoom.jpg
description: How to wire and program Kendryte K210 based development boards.
tags:
    - Electronics
    - K210
    - HAGL
...
For programming the K210 the only option at the moment seems to be the [Kendryte Standalone SDK](https://github.com/kendryte/kendryte-standalone-sdk). It has not been updated for a while; the last release was in 2019. There has been some activity in `develop` branch but at least at the time of writing it does not compile.

There also used to be a [Kendryte FreeRTOS SDK](https://github.com/kendryte/kendryte-freertos-sdk) but it is no longer maintained.


The SDK itself is decent but the documentation is almost nonexistent. There is a [programming guide](https://github.com/kendryte/kendryte-doc-standalone-programming-guide) but it mostly just lists the functions the SDK provides, but not how to actually use them. This actually is quite usual problem with Chinese vendors. Hardware is great but documentation and software is lacking.

It almost feels like Canaan started with big plans and then either either ran out of money or  their interest moved somewhere else. Latter might be closer to truth since their [Twitter account]() mostly has crypto mining related posts.

In any case when cloning the SDK

```
$ git clone -b V0.5.7 https://github.com/kendryte/kendryte-standalone-sdk.git
```
